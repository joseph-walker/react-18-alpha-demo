(() => {
    ...
    "node_modules/react/cjs/react.development.js"(exports, module) {
      ...
      if (true) {
        (function() {
          ...
          var ReactVersion = "18.0.0-930c9e7ee-20211015";
    ...
    "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
      ...
      if (true) {
        (function() {
          ...
          var RefStatic = 1048576;
          var LayoutStatic = 2097152;
          var PassiveStatic = 4194304;
          var MountLayoutDev = 8388608;
          var MountPassiveDev = 16777216;
          ...
          function getLaneLabels() {
            if (laneLabels.length === 0) {
              var lane = 1;
              for (var index2 = 0; index2 < TotalLanes$1; index2++) {
          ...
          function propagateContextChange_eager(workInProgress2, context, renderLanes2) {
            ...
            while (fiber !== null) {
              ...
              if (list !== null) {
                ...
                scheduleWorkOnParentPath(parentSuspense, renderLanes2);
          ...
          function readFromUnsubscribedMutableSource(root2, source, getSnapshot) {
            {
          ...
          function useMutableSource(hook, source, getSnapshot, subscribe) {
            ...
            var _dispatcher$useState = dispatcher.useState(function() {
              return readFromUnsubscribedMutableSource(root2, source, getSnapshot);
            ...
            if (!objectIs(prevGetSnapshot, getSnapshot) || !objectIs(prevSource, source) || !objectIs(prevSubscribe, subscribe)) {
              ...
              snapshot = readFromUnsubscribedMutableSource(root2, source, getSnapshot);
          ...
          function attachWakeableListeners(suspenseBoundary, root2, wakeable, lanes) {
            if (suspenseBoundary.mode & ConcurrentMode) {
              var pingCache = root2.pingCache;
              var threadIDs;
              if (pingCache === null) {
                pingCache = root2.pingCache = new PossiblyWeakMap$2();
                threadIDs = new Set();
          ...
          function markNearestSuspenseBoundaryShouldCapture(returnFiber, sourceFiber, root2, rootRenderLanes) {
          ...
          function throwException(root2, returnFiber, sourceFiber, value, rootRenderLanes) {
            ...
            if (value !== null && typeof value === "object" && typeof value.then === "function") {
              ...
              var suspenseBoundary = markNearestSuspenseBoundaryShouldCapture(returnFiber, sourceFiber, root2, rootRenderLanes);
              if (suspenseBoundary !== null) {
                attachWakeableListeners(suspenseBoundary, root2, wakeable, rootRenderLanes);
                return;
              } else {
              ...
              if (getIsHydrating() && sourceFiber.mode & ConcurrentMode) {
                var _suspenseBoundary = markNearestSuspenseBoundaryShouldCapture(returnFiber, sourceFiber, root2, rootRenderLanes);
            ...
            switch (workInProgress2.tag) {
              ...
              case LegacyHiddenComponent: {
                ...
                if (current2 !== null) {
                  ...
                  if (prevIsHidden !== nextIsHidden && newProps.mode !== "unstable-defer-without-hiding" && workInProgress2.tag !== LegacyHiddenComponent) {
                ...
                if (!nextIsHidden || (workInProgress2.mode & ConcurrentMode) === NoMode) {
                  ...
                  if (includesSomeLane(subtreeRenderLanes, OffscreenLane)) {
                    bubbleProperties(workInProgress2);
                    {
                      if (workInProgress2.tag !== LegacyHiddenComponent && workInProgress2.subtreeFlags & (Placement | Update) && newProps.mode !== "unstable-defer-without-hiding") {
                        workInProgress2.flags |= Visibility;
                      }
                    }
                  }
          ...
          function updateHostRoot(current2, workInProgress2, renderLanes2) {
            ...
            if (root2.isDehydrated && enterHydrationState(workInProgress2)) {
              {
          ...
          function unwindInterruptedWork(interruptedWork, renderLanes2) {
          ...
          function commitMutationEffects(root2, firstChild, committedLanes) {
            ...
            nextEffect = firstChild;
            commitMutationEffects_begin(root2);
            inProgressLanes = null;
            inProgressRoot = null;
          }
          function commitMutationEffects_begin(root2) {
            while (nextEffect !== null) {
              var fiber = nextEffect;
              ...
              if ((fiber.subtreeFlags & MutationMask) !== NoFlags && child !== null) {
                ...
                commitMutationEffects_complete(root2);
              }
            }
          }
          function commitMutationEffects_complete(root2) {
            while (nextEffect !== null) {
              var fiber = nextEffect;
              setCurrentFiber(fiber);
              try {
                commitMutationEffectsOnFiber(fiber, root2);
              } catch (error2) {
                reportUncaughtErrorInDEV(error2);
                captureCommitPhaseError(fiber, fiber.return, error2);
              }
          ...
          var ceil = Math.ceil;
          var ReactCurrentDispatcher$2 = ReactSharedInternals.ReactCurrentDispatcher, ReactCurrentOwner$2 = ReactSharedInternals.ReactCurrentOwner, ReactCurrentBatchConfig$3 = ReactSharedInternals.ReactCurrentBatchConfig, ReactCurrentActQueue = ReactSharedInternals.ReactCurrentActQueue;
          var NoContext = 0;
          var BatchedContext = 1;
          var RenderContext = 2;
          var CommitContext = 4;
          var RetryAfterError = 8;
          ...
          function scheduleUpdateOnFiber(fiber, lane, eventTime) {
            ...
            if ((executionContext & RenderContext) !== NoLanes && root2 === workInProgressRoot) {
              ...
              if (lane === SyncLane && executionContext === NoContext && (fiber.mode & ConcurrentMode) === NoMode && !ReactCurrentActQueue.isBatchingLegacy) {
                resetRenderTimer();
          ...
          function ensureRootIsScheduled(root2, currentTime) {
            ...
            if (existingCallbackPriority === newCallbackPriority && !(ReactCurrentActQueue.current !== null && existingCallbackNode !== fakeActCallbackNode)) {
              {
          ...
          function recoverFromConcurrentError(root2, errorRetryLanes) {
            ...
            for (var i = 0; i < MAX_ERROR_RETRY_ATTEMPTS; i++) {
              exitStatus = renderRootSync(root2, errorRetryLanes);
          ...
          function commitRoot(root2) {
            ...
            try {
              ReactCurrentBatchConfig$3.transition = 0;
              setCurrentUpdatePriority(DiscreteEventPriority);
              commitRootImpl(root2, previousUpdateLanePriority);
            } finally {
              ReactCurrentBatchConfig$3.transition = prevTransition;
          ...
          function warnIfNotCurrentlyActingEffectsInDEV(fiber) {
            {
              if ((fiber.mode & StrictLegacyMode) !== NoMode && ReactCurrentActQueue.current === null && ReactCurrentActQueue.disableActWarning === false) {
          ...
          function warnIfNotCurrentlyActingUpdatesInDEV(fiber) {
            {
              if (executionContext === NoContext && ReactCurrentActQueue.current === null && ReactCurrentActQueue.disableActWarning === false) {
                var previousFiber = current;
                try {
                  setCurrentFiber(fiber);
          ...
          function createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride) {
          ...
          function createContainer(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride) {
            return createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode);
          }
          ...
          function createRoot(container, options2) {
            ...
            var isStrictMode = options2 != null && options2.unstable_strictMode === true;
            var root2 = createContainer(container, ConcurrentRoot, hydrate2, hydrationCallbacks, isStrictMode);
          ...
          function hydrateRoot2(container, initialChildren, options2) {
            ...
            var isStrictMode = options2 != null && options2.unstable_strictMode === true;
            var root2 = createContainer(container, ConcurrentRoot, true, hydrationCallbacks, isStrictMode);
            markContainerAsRoot(root2.current, container);
            ...
            updateContainer(initialChildren, root2, null, null);
            return new ReactDOMRoot(root2);
          }
          ...
          function legacyCreateRootFromDOMContainer(container, forceHydrate) {
            ...
            var root2 = createContainer(container, LegacyRoot, forceHydrate, null, false);
            markContainerAsRoot(root2.current, container);
            var rootContainerElement = container.nodeType === COMMENT_NODE ? container.parentNode : container;
            listenToAllSupportedEvents(rootContainerElement);
            return root2;
          ...
          exports.hydrateRoot = hydrateRoot2;
  ...
  // client/index.jsx
  (0, import_react_dom.hydrateRoot)(document, /* @__PURE__ */ React.createElement(App, null));
})();
/*
object-assign
(c) Sindre Sorhus
